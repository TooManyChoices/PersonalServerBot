...
namespace Bot
{
    class SubscribedMessages
    {
        ...
        public static void Init()
        {
            ...
            timer.Elapsed += (object a, ElapsedEventArgs b) => NewRandomStatus();
            NewRandomStatus();
            timer.Start();
        ...
        private async static void NewRandomStatus()
        {
            await Program.GetClient().SetGameAsync(Person.GetRandomItem("random_status"), type: ActivityType.CustomStatus);
        }

        // i won't delete the function ig
